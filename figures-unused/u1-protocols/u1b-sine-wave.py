...
for cell in cell_list:
    ...
    # Create figure
    fig = plt.figure(figsize=mm(70, 55), dpi=200)
    grid = GridSpec(2, 3, hspace=0.15, wspace=0.17)

    protocol = 7

    g = GridSpec(3, 1, hspace=0.01)
    ...
    # Finalise
    fig.subplots_adjust(0.14, 0.135, 0.98, 0.99)
    fig.savefig(base + '-cell-' + str(cell) + '.png')
    fig.savefig(base + '-cell-' + str(cell) + '.eps')
